...
_LanguageSeed _sundaSeed() {
  return const _LanguageSeed(
    id: 'sunda',
    name: 'Bahasa Sunda',
    nativeName: 'Basa Sunda Lemes',
    shortName: 'Sunda',
    region: 'Jawa Barat dan Banten',
    sourceName: 'Undak-Usuk Basa Sunda (Basa Loma - Basa Lemes)',
    sourceUrl: 'PDF lokal: ilide.info-basa-lemes-pr.pdf',
    license: 'Referensi undak-usuk umum, dikurasi untuk pembelajaran internal',
    seedVersion: 5,
    units: [
      _UnitSeed(
        unitNo: 1,
        ...
        description:
            'Unit ini mengenalkan sapaan, ungkapan sopan, dan perkenalan diri sederhana dalam basa lemes.',
      ...
      _UnitSeed(
        ...
        description:
            'Unit ini mengenalkan kosakata keluarga, orang sekitar, dan sifat sederhana dalam basa lemes.',
        ...
        sentences: [
          _SentenceSeed(
            words: ['ieu', 'pun bapa'],
            local: 'ieu pun bapa',
            displayLocal: 'Ieu pun bapa.',
            translation: 'Ini ayah saya.',
            extraAcceptedAnswers: ['Ini bapak saya.', 'ini bapak saya'],
          ),
          _SentenceSeed(
            words: ['ieu', 'babaturan', 'abdi'],
            local: 'ieu babaturan abdi',
            displayLocal: 'Ieu babaturan abdi.',
      ...
      _UnitSeed(
        ...
        description:
            'Unit ini mengenalkan angka, jumlah, hari, dan waktu sederhana dalam basa lemes.',
        ...
        sentences: [
          ...
          _SentenceSeed(
            words: ['enjing', 'abdi', 'ka', 'sakola'],
            local: 'enjing abdi ka sakola',
            displayLocal: 'Enjing abdi ka sakola.',
      ...
      _UnitSeed(
        ...
        description:
            'Unit ini mengenalkan kosakata makanan, rasa, dan percakapan belanja sederhana dalam basa lemes.',
        ...
        sentences: [
          _SentenceSeed(
            words: ['abdi', 'neda', 'sangu'],
            local: 'abdi neda sangu',
            displayLocal: 'Abdi neda sangu.',
            translation: 'Saya makan nasi.',
          ),
          _SentenceSeed(
            words: ['abdi', 'ngaleueut', 'cai'],
            local: 'abdi ngaleueut cai',
            displayLocal: 'Abdi ngaleueut cai.',
      ...
      _UnitSeed(
        ...
        description:
            'Unit ini mengenalkan tempat, arah, dan kalimat perjalanan sederhana dalam basa lemes.',
        ...
        sentences: [
          ...
          _SentenceSeed(
            words: ['pun biang', 'ka', 'pasar'],
            local: 'pun biang ka pasar',
            displayLocal: 'Pun biang ka pasar.',
            translation: 'Ibu ke pasar.',
          ),
          _SentenceSeed(
            words: ['babaturan', 'abdi', 'dongkap'],
            local: 'babaturan abdi dongkap',
            displayLocal: 'Babaturan abdi dongkap.',
      ...
      _UnitSeed(
        ...
        description:
            'Unit ini berisi ungkapan sehari-hari, budaya lokal, dan review percakapan dalam basa lemes.',
...
_LanguageSeed _jawaSeed() {
  return const _LanguageSeed(
    id: 'jawa',
    name: 'Bahasa Jawa',
    nativeName: 'Basa Jawa Krama',
    shortName: 'Jawa',
    region: 'Jawa Tengah, Yogyakarta, Jawa Timur',
    sourceName: 'Kamus Bahasa Jawa Lengkap (Ngoko-Krama Madya-Krama Inggil)',
    sourceUrl: 'PDF lokal: kamusbahasajawalengkap-150325082031-conversion-gate01.pdf',
    license: 'Referensi kamus umum, dikurasi untuk pembelajaran internal',
    seedVersion: 2,
    units: [
      _UnitSeed(
        unitNo: 1,
        title: 'Perkenalan & Sapaan',
        description:
            'Unit ini mengenalkan sapaan, ungkapan sopan, dan perkenalan diri sederhana dalam Bahasa Jawa krama.',
        level1Title: 'Sapaan Dasar',
        level2Title: 'Cocokkan Kata Ganti',
        level3Title: 'Susun Kalimat Perkenalan',
        level4Title: 'Terjemahkan Sapaan',
        ...
        sentences: [
          _SentenceSeed(
            words: ['kula', 'saking', 'Yogyakarta'],
            local: 'kula saking Yogyakarta',
            displayLocal: 'Kula saking Yogyakarta.',
            translation: 'Saya dari Yogyakarta.',
          ),
          _SentenceSeed(
            words: ['nama', 'kula', 'Loka'],
            local: 'nama kula Loka',
            displayLocal: 'Nama kula Loka.',
            translation: 'Nama saya Loka.',
          ),
          _SentenceSeed(
            words: ['kadospundi', 'kabaripun'],
            local: 'kadospundi kabaripun',
            displayLocal: 'Kadospundi kabaripun?',
            translation: 'Apa kabar?',
          ),
        ],
      ),
      _UnitSeed(
        ...
        title: 'Keluarga & Orang Sekitar',
        description:
            'Unit ini mengenalkan kosakata keluarga, orang sekitar, dan sifat sederhana dalam Bahasa Jawa krama.',
        level1Title: 'Anggota Keluarga',
        level2Title: 'Cocokkan Orang Sekitar',
        level3Title: 'Susun Kalimat Keluarga',
        level4Title: 'Terjemahkan Kalimat Keluarga',
        ...
        sentences: [
          _SentenceSeed(
            words: ['punika', 'bapak', 'kula'],
            local: 'punika bapak kula',
            displayLocal: 'Punika bapak kula.',
            translation: 'Ini ayah saya.',
          ),
          _SentenceSeed(
            words: ['punika', 'rencang', 'kula'],
            local: 'punika rencang kula',
            displayLocal: 'Punika rencang kula.',
            translation: 'Ini teman saya.',
          ),
          _SentenceSeed(
            words: ['adhi', 'kula', 'pinter'],
            local: 'adhi kula pinter',
            displayLocal: 'Adhi kula pinter.',
      ...
      _UnitSeed(
        ...
        title: 'Angka, Waktu & Hari',
        description:
            'Unit ini mengenalkan angka, hari, dan waktu sederhana dalam Bahasa Jawa krama.',
        level1Title: 'Angka Dasar',
        level2Title: 'Cocokkan Waktu Sederhana',
        level3Title: 'Susun Kalimat Waktu',
        level4Title: 'Terjemahkan Kalimat Waktu',
        ...
        sentences: [
          _SentenceSeed(
            words: ['samenika', 'kula', 'sinau'],
            local: 'samenika kula sinau',
            displayLocal: 'Samenika kula sinau.',
            translation: 'Sekarang saya belajar.',
          ),
          _SentenceSeed(
            words: ['benjing', 'kula', 'dhateng', 'sekolah'],
            local: 'benjing kula dhateng sekolah',
            displayLocal: 'Benjing kula dhateng sekolah.',
            translation: 'Besok saya ke sekolah.',
          ),
          _SentenceSeed(
            words: ['kala', 'wingi', 'kula', 'dhateng', 'peken'],
            local: 'kala wingi kula dhateng peken',
            displayLocal: 'Kala wingi kula dhateng peken.',
            translation: 'Kemarin saya ke pasar.',
          ),
        ],
      ),
      _UnitSeed(
        ...
        title: 'Makanan & Belanja',
        description:
            'Unit ini mengenalkan kosakata makanan, rasa, dan percakapan belanja sederhana dalam Bahasa Jawa krama.',
        level1Title: 'Makanan Dasar',
        level2Title: 'Cocokkan Rasa & Belanja',
        level3Title: 'Susun Kalimat Makanan',
        level4Title: 'Terjemahkan Kalimat Makanan',
        ...
        sentences: [
          _SentenceSeed(
            words: ['kula', 'nedha', 'sekul'],
            local: 'kula nedha sekul',
            displayLocal: 'Kula nedha sekul.',
            translation: 'Saya makan nasi.',
          ),
          _SentenceSeed(
            words: ['kula', 'ngunjuk', 'toya'],
            local: 'kula ngunjuk toya',
            displayLocal: 'Kula ngunjuk toya.',
            translation: 'Saya minum air.',
          ),
          _SentenceSeed(
            words: ['pinten', 'regi', 'punika'],
            local: 'pinten regi punika',
            displayLocal: 'Pinten regi punika?',
            translation: 'Berapa harga ini?',
          ),
        ],
      ),
      _UnitSeed(
        ...
        title: 'Arah, Tempat & Perjalanan',
        description:
            'Unit ini mengenalkan tempat, arah, dan kalimat perjalanan sederhana dalam Bahasa Jawa krama.',
        level1Title: 'Tempat Dasar',
        level2Title: 'Cocokkan Arah & Perjalanan',
        level3Title: 'Susun Kalimat Perjalanan',
        level4Title: 'Terjemahkan Kalimat Perjalanan',
        ...
        sentences: [
          _SentenceSeed(
            words: ['kula', 'dhateng', 'sekolah'],
            local: 'kula dhateng sekolah',
            displayLocal: 'Kula dhateng sekolah.',
            translation: 'Saya ke sekolah.',
          ),
          _SentenceSeed(
            words: ['ibu', 'dhateng', 'peken'],
            local: 'ibu dhateng peken',
            displayLocal: 'Ibu dhateng peken.',
            translation: 'Ibu ke pasar.',
          ),
          _SentenceSeed(
            words: ['rencang', 'kula', 'dugi'],
            local: 'rencang kula dugi',
            displayLocal: 'Rencang kula dugi.',
            translation: 'Teman saya datang.',
          ),
        ],
      ),
      _UnitSeed(
        ...
        title: 'Budaya & Percakapan Harian',
        description:
            'Unit ini berisi ungkapan sehari-hari, budaya lokal, dan review percakapan Bahasa Jawa krama.',
        level1Title: 'Ungkapan Sopan Harian',
        level2Title: 'Cocokkan Percakapan & Budaya',
        level3Title: 'Susun Kalimat Percakapan',
        level4Title: 'Terjemahkan Kalimat Percakapan',
        ...
        sentences: [
          _SentenceSeed(
            words: ['monggo', 'mlebet'],
            local: 'monggo mlebet',
            displayLocal: 'Monggo mlebet.',
            translation: 'Silakan masuk.',
          ),
          _SentenceSeed(
            words: ['mugi', 'saras'],
            local: 'mugi saras',
            displayLocal: 'Mugi saras.',
            translation: 'Semoga sehat.',
            extraAcceptedAnswers: ['Semoga baik.', 'semoga baik'],
          ),
          _SentenceSeed(
            words: ['sampeyan', 'kedah', 'sopan'],
            local: 'sampeyan kedah sopan',
            displayLocal: 'Sampeyan kedah sopan.',
            translation: 'Anda harus sopan.',
            extraAcceptedAnswers: ['Kamu harus sopan.', 'kamu harus sopan'],
          ),
        ],
